...
#	reg.add(Dropout(0.01))
	reg.add(Dense(30, activation='relu', kernel_initializer='he_normal', kernel_regularizer=keras.regularizers.l2(0.1)))
	reg.add(Dense(20, activation='relu', kernel_initializer='he_normal', kernel_regularizer=keras.regularizers.l2(0.1)))
#	reg.add(Dropout(0.01))
	reg.add(Dense(10, activation='relu', kernel_initializer='he_normal', kernel_regularizer=keras.regularizers.l2(0.1)))
	reg.add(Dense(5, activation='relu', kernel_initializer='he_normal', kernel_regularizer=keras.regularizers.l2(0.1)))
	reg.add(Dense(1))
